...
class PassengerProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final PassengerControllerImp controllerImp = Get.put(PassengerControllerImp());
    return Scaffold(
      appBar: AppBar(
        title:  Center(
          child: Text(
                                    ...
                                    ...ListTile.divideTiles(
                                      ...
                                      tiles: [
                                        ListTile(
                                          ...
                                          subtitle: Text(controllerImp.currentPassenger!.fullname ?? 'fullName'),
                                        ),
                                        ListTile(
                                          leading: Icon(Icons.email),
                                          title: Text("email address:".tr),
                                          subtitle:  Text(controllerImp.currentPassenger!.emailAddress ?? 'emailAddress'),
                                        ),
                                        ListTile(
                                          leading: Icon(Icons.phone),
                                          title: Text("phone number:".tr),
                                          subtitle:  Text(controllerImp.currentPassenger!.phoneNumber ?? 'phoneNumber'),
                                        ),
